...
# (Location logic simplified to stable IP-based detection only)
# --------------------------------------------------------------
...
def detect_user_city():
    """IP-based detection using ipinfo.io (no coordinates shown)."""
    try:
        r = requests.get("https://ipinfo.io/json", timeout=5)
        data = r.json()
        # ipinfo returns city, region, country etc.
...
# --------------------------------------------------------------
# GET AUTO CITY USING IP (stable, no lat/lon shown)
# --------------------------------------------------------------
